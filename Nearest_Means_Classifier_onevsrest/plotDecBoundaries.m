...
plot(training(label_train == 1,1),training(label_train == 1,2), 'mx');
plot(training(label_train == 2,1),training(label_train == 2,2), 'go');
if nclass == 3
    plot(training(label_train == 3,1),training(label_train == 3,2), 'c*');
end
...
mean2 = plot(sample_mean(2,1),sample_mean(2,2), 'bd', ...
